...
export default function Navbar() {
  ...
  return (
    <header
      className={`fixed top-0 left-0 w-full z-[100] transition-all duration-500 font-henju ${
    ...
    >
      ...
      >
        ...
        >
          ...
          <div className="flex flex-col leading-none">
            <div className="flex items-center">
              ...
              <span className="text-[#4FA097] text-2xl font-bold mb-1 ml-0.5">
                .
              </span>
            </div>
            <span className="text-[12px] font-medium tracking-[3px] pl-10 text-gray-800 mt-[-2px]">
              CLINIC
            </span>
          </div>
        </div>
                ...
                <AnimatePresence>
                  {open && (
                    <motion.div
                      ...
                      className="absolute left-0 top-full mt-2 w-[240px] bg-white border border-gray-200 rounded-lg shadow-lg p-3 flex flex-col gap-1 z-[9999]"
                    >
        ...
        <div className="flex items-center gap-3 xl:gap-4">
          <button className="bg-[#4FA097] text-white px-4 py-2 rounded-full hidden lg:flex items-center gap-2 hover:bg-[#3d7f7a] transition">
          ...
          <div className="hidden lg:flex items-center gap-4">
            <span className="cursor-pointer hover:text-[#4FA097] text-sm">
              My Treatments
            </span>
        ...
        {mobileMenu && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-0 right-0 w-[80%] max-w-[360px] h-full bg-[#b0e8e3] shadow-lg flex flex-col z-50 overflow-y-auto"
            >
              ...
              <div className="px-6 py-6 mt-auto">
                <button className="w-full bg-[#4FA097] text-white px-4 py-3 rounded-full flex items-center justify-center gap-2 hover:bg-[#3d7f7a] transition">
                  <span>Consult Now</span>
                  <span className="w-6 h-6 rounded-full bg-white flex items-center justify-center">
                    <ArrowRight className="w-4 h-4 text-[#4FA097]" />
                  </span>
